...
public class CollisionGUI extends DrawingGUI {
	...
	private void findColliders() {
		...
		for (Blob b: blobs){
			List<Blob> tempColliders= blobTree.findInCircle(b.x, b.y, b.r+1);

			tempColliders.removeIf(collider -> b.x == collider.x && b.y == collider.y);
			colliders.addAll(tempColliders);
		}
